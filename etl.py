...
def process_log_file(cur, filepath):
    ...
    for index, row in df.iterrows():
        ...
        songplay_data = (songid,row.start_time,row.userId,row.level,artistid,row.sessionId,row.location,row.userAgent )
